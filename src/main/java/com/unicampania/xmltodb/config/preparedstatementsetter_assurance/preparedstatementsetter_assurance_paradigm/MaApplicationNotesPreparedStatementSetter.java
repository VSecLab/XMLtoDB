...
public class MaApplicationNotesPreparedStatementSetter implements ItemPreparedStatementSetter<AClass> {
    @Override
    public void setValues(AClass item, PreparedStatement ps) throws SQLException {
        ...
        ps.setString(2, String.valueOf(item.getMaIntroduction().getCombo())
                .replace("[","")
                .replace("]",""));
